      ...
      <div className="relative max-w-4xl mx-auto px-6">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-mula-accent/10 border border-mula-accent/20 mb-8">
            <Sparkles className="w-4 h-4 text-mula-accent" />
            <span className="text-sm text-mula-accent-light font-medium">Zainicjuj innowację</span>
          </div>

          <h2 className="text-3xl md:text-5xl font-bold text-mula-text mb-6">
            Masz pomysł na produkt przyszłości?
          </h2>
          <p className="text-lg text-mula-text-muted max-w-2xl mx-auto mb-10 leading-relaxed">
            Umów bezpłatną konsultację. Przeanalizujemy Twój pomysł, zidentyfikujemy potencjał rynkowy
            i zaproponujemy konkretny plan działania — od koncepcji po pierwsze MVP.
          </p>
        </motion.div>

        <ContactForm competency="Innowacje i Startupy" />
      </div>
    </section>
  )
}
