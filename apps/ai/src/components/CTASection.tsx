      ...
      <div className="relative max-w-4xl mx-auto px-6">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-mula-accent/10 border border-mula-accent/20 mb-8">
            ...
            <span className="text-sm text-mula-accent-light font-medium">Rozpocznij z AI</span>
          </div>

          <h2 className="text-3xl md:text-5xl font-bold text-mula-text mb-6">
            Gotowy na AI w swojej firmie?
          </h2>
          <p className="text-lg text-mula-text-muted max-w-2xl mx-auto mb-10 leading-relaxed">
            Umów bezpłatną konsultację. Przeanalizujemy Twoje procesy, zidentyfikujemy obszary do automatyzacji
            i zaproponujemy konkretne rozwiązanie dopasowane do potrzeb.
          </p>
        </motion.div>

        <ContactForm competency="AI i Automatyzacja" />
      </div>
    </section>
  )
}
