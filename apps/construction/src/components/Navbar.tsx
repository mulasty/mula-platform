      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="hidden md:block">
            <a
              href="#contact"
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-construction hover:bg-red-500 text-white text-sm font-medium rounded-full transition-all duration-200 hover:shadow-lg hover:shadow-red-500/25"
            >
              Wyceń halę
            </a>
          </div>
        ...
        {mobileOpen && (
          ...
          >
            ...
            <motion.a
              ...
              onClick={() => setMobileOpen(false)}
              className="mt-4 px-8 py-3 bg-construction hover:bg-red-500 text-white rounded-full font-medium transition-all"
            >
              Wyceń halę
            </motion.a>
          </motion.div>
